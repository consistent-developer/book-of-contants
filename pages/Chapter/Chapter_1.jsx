...
export default function Guides() {
  ...
  return (
    <div className='mb-10 text-sm md:text-base'>
      <ReadMinutes />
      <div className='tracking-widest mx-2 pb-10 lg:mx-60 px-4'>
        {/* Hero Image  */}
        <h1 className='pb-3 text mt-4 text-2xl lg:text-3xl font-bold text-center tracking-widest text'>CHAPTER 1</h1>
