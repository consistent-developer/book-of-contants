    ...
    <div className="mt-0.5 bg-white tracking-wider" >
      <nav className="text-base text-gray-600 lg:text-xl">
        ...
        {/* // <ul className="flex  mt-4 mb-6 flex cursor-pointer">
          //   <li className="px-1 md:mx-3 self-center bg-gray-200 p-0.5"><Link href="/home"><a>Home</a></Link></li>
          //   <li className="px-1 md:mx-3 self-center bg-gray-200 p-0.5"><Link href="/home"><a>Chapters</a></Link></li>
          //   <li className="px-1 md:mx-3 self-center bg-gray-200 p-0.5"><Link href="/home"><a>Projects</a></Link></li>
          // </ul> */}
